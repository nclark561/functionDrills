...
console.log(compareNums(192, 192));
...
//CODE HERE
const nameCheck = name => name === 'Steven' ? 'What is up Steven?' : name === 'Bryan' ? 'Hey Bryan!' : `Cool name, ${name}`;
let nameGreeting = nameCheck('Noah');
...
//CODE HERE
const bestMovie = mvie => `${mvie} is the best movie ever!`;
console.log(bestMovie('Hercules'));
...
//CODE HERE
const fun = str => console.log(str.toUpperCase());
fun(sampleString);
...
console.log(emailCheck('noah@email.com'));
...
//CODE HERE
console.log('Already addressed this issue.');

console.log('--------');
////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0, 1, 2, 3, 6, 4]
/*
...
let arrayIsAscending = isAsc(sampleArray);
